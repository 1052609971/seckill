...
/**
* @Description: 秒杀订单消费者，创建订单消息，经过优化之后已经被consumerConf取代了
        * @Author: longjian
        * @Date: 10:57 2022/6/16
        */
public class SecKillConsumer {
    public void consumeSecOrder(OrderServiceImpl orderService, GoodsServiceImpl goodsService, RedisTemplate redisTemplate) throws Exception {
